...
public class MusicManager : MonoBehaviour
{
    ...
    private GameObject m_world; // This is for editing all the audio source volumes on the premade soundfx
    ...
    private void setWorldSoundFXVolume()
    {
        if( m_world != null )
        {
            AudioSource[] sources = m_world.GetComponentsInChildren<AudioSource>();
            foreach (AudioSource src in sources)
            {
                src.volume = m_soundFXVolume;
            }
        }
    }
